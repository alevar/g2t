...
class TXGroup:
    ...
    def __init__(self):
        ...
        self.interval_index = IntervalTree() # index over all objects in the group
    ...
    def build_index(self):
        """
        Build an interval index over all objects in the TXGroup.
        """
        self.interval_index.clear()
        for idx, obj in enumerate(self.objects):
            self.interval_index.addi(obj.get_start(),obj.get_end(),idx)
...
class Bundle (TXGroup,Object):
    ...
    Unlike TXGroup, since Bundle inherits from Object, it has start and end and is guaranteed to exist on the same seqid and strand
    """
    def __init__(self):
